...
A monorepo containing all of my solo projects from [Scrimba's](https://scrimba.com) learning paths.

Each solo project is a standalone challenge completed as part of a Scrimba course, organized here by learning path.

## Frontend Path

### [solo-color-api](frontend-path/solo-color-api)
A color palette generator that fetches schemes from the ColorAPI. Built with **vanilla JavaScript** and **Tailwind CSS**, demonstrating API integration and dynamic DOM manipulation.

### [solo-components](frontend-path/solo-components)
A reusable React component library showcasing modern design system patterns. Built with **React 19**, **CSS Modules**, **Context API**, and **React Router v7** — featuring compound components, custom hooks, and portal rendering.

### [solo-hangman](frontend-path/solo-hangman)
A multilingual Hangman word guessing game. Built with **React**, focusing on game state logic, conditional rendering, and win/lose detection with confetti animations.

### [solo-movies](frontend-path/solo-movies)
...
### [solo-routing](frontend-path/solo-routing)
...
### [solo-gold-digger](fullstack-path/solo-gold-digger)
A gold investment app that streams live prices and logs purchases. Built with **raw Node.js** (no framework), featuring **Server-Sent Events** for real-time data, POST endpoint handling, and file system logging.

### [solo-polyglot](fullstack-path/solo-polyglot)
A translation app supporting French, Spanish, and Japanese. Built with **Bun** and **TypeScript**, integrating the **OpenAI API** for natural language translation.
